package com.pac.config.timezone;

import com.pac.PaymentAppCore;
import com.pac.repository.timezone.DateTimeWrapper;
import com.pac.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM pa_date_time_wrapper where id=%d", fieldName, id);
    }
